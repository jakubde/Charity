                    ...
                    <div class="col-6">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Dodawanie admina</h6>
                            </div>
                            <div class="card-body">
<%--                                <form class="user">--%>
                                <form:form method="post" cssClass="user" modelAttribute="admin" id="adminForm">
                                <div class="form-group">
                                    <form:input path="email" type="email" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Email"/>
                                </div>
                                <div class="form-group">
                                    <form:input path="password" type="password" class="form-control form-control-user" id="exampleInputPassword" placeholder="Hasło"/>
                                </div>
                                <div class="form-group">
