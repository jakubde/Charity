...
<html lang="en">
    <head>
        ...
        <title><spring:message code="editing.an.admin"/></title>
                            ...
                            <div class="col-5">
                                ...
                                <div class="card shadow mb-4">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary"><spring:message code="editing.an.admin"/></h6>
                                    </div>
                                    <div class="card-body">
                                        <form:form method="post" cssClass="user" modelAttribute="admin" id="adminEditForm">
                                            ...
                                            <hr>
                                            <a href="javascript:{}" onclick="document.getElementById('adminEditForm').submit();"
